...
for Participant_Num = 1:N_Participants
    ...
    if Participant_Num < 10
        mkdir(['20220912_S0' num2str(Participant_Num)])
        cd(['20220912_S0' num2str(Participant_Num)])
    else
        mkdir(['20220912_S' num2str(Participant_Num)])
        cd(['20220912_S' num2str(Participant_Num)])
    end
    ...
    if Participant_Num < 10
        writematrix(SLA', ...
            ['20220912_S0' num2str(Participant_Num) '_SLA.csv'])
    else
        writematrix(SLA', ...
            ['20220912_S' num2str(Participant_Num) '_SLA.csv'])
    end
    cd(Home)
end
linkaxes(ax)
